...
function Sidebar({active}) {
  ...
  const btnArray = ['Dashboard', 'Users','Chats','Notes' ,'Advertisments', 'Reports','Business', 'Groups','Verification']
  const redirectLinks = [' ','users','chats','notes','ads','reports','business','groups','verification']
  const redirectUrl = (i)=>{
